...
(* OASIS_START *)
(* DO NOT EDIT (digest: 08ce7f43f37abf6fd5e9ab4392ad1694) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights =
            ["(C) 2013 Dave Parfitt"; "(C) 2013 Basho Technologies"];
          maintainers = [];
          authors = ["Dave Parfitt"];
          homepage = None;
          synopsis = "Taste of Riak sample app";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "taste_of_riak.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "?ñz\137\134<:\003Å\137\134\1290½p\158";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
